...
def merge(name):
    ...
    a['ADD[DIF26(low_close) , vol_skew126]']=f.DIF(a['low_close'],26)+a['vol_skew126']
    a['DIF63(STD63(PROD[vol_skew126 , vol_skew126]))']=f.DIF(f.STD(a['vol_skew126']*a['vol_skew126'],63),63)
