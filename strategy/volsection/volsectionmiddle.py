...
class Section_Momentum_BackTest(BackTest):
    ...
    def handle_bar(self, m_data, context):
        ...
        if not context.fired:
            ...
            start_index = (len(ranking)-sigma_range)//2
...
if(__name__=="__main__"):
    ...
    for n in [2,3,4,5,10,20]:
        for h in [0.3,0.4,0.5,0.6,0.7,0.8,0.9]:
            ...
            engine.context.name = f"newvolseclast_SigmaRange{h}_N{n}"
            p.apply_async(engine.loop_process,args=("20120101","20240501","back/vol/newvolseclast/"))
