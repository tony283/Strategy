...
if(__name__=="__main__"):
    ...
    for n in [i for i in range(2,20)]+[30,60]:
        for h in [0.1,0.15,0.2,0.25,0.3]:
            ...
            engine.context.name = f"newsecbreak_Range{h:.2f}_N{n}"
            p.apply_async(engine.loop_process,args=("20120101","20240501","back/section/newsecbreak/"))
